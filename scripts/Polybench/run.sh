...
do
    ...
    then
        ...
        then
        	cd $POLYBENCH/
        	$CLANG $NATIVE_FLAGS -I utilities -I datamining/$val linear-algebra/blas/$val/$val.c -DPOLYBENCH_DUMP_ARRAYS -DEXTRALARGE_DATASET -DPOLYBENCH_TIME -o datamining/$val/$val.bc
			$CLANG $NATIVE_FLAGS -I utilities utilities/polybench.c -DPOLYBENCH_TIME -o utilities/polybench.bc
			$LINK datamining/$val/$val.bc utilities/polybench.bc -o datamining/$val/$val$MERGED
			$OPT -O0 datamining/$val/$val$MERGED -o datamining/$val/out.bc
			$OPT $PREC_FLAG datamining/$val/out.bc -o datamining/$val/out_1.bc
        ...
        then
			...
			$OPT $VECT_FLAG datamining/$val/out.bc -o datamining/$val/out_1.bc
			$OPT $PREC_FLAG datamining/$val/out.bc -o datamining/$val/out_2.bc
			$CLANG $GETPHASE_FLAGS $INSTRFUNC datamining/$val/out_1.bc -o datamining/$val/$val -lm
			echo "Executing " $val 
			cd datamining/$val/ && ./$val > $val.$1.txt 2>&1
			diff <(head -n -1 $val.native.txt) <(head -n -1 $val.$1.txt)
			tail -1 $val.$1.txt
        fi
    	elif [ $1 == "map-annotation" ];
        then
        	cd $POLYBENCH/
        	$CLANG $USE_FLAGS -I utilities -I datamining/$val linear-algebra/blas/$val/$val.c -DPOLYBENCH_DUMP_ARRAYS -DEXTRALARGE_DATASET -DPOLYBENCH_TIME -o datamining/$val/$val.bc
			$CLANG $USE_FLAGS -I utilities utilities/polybench.c -DPOLYBENCH_TIME -o utilities/polybench.bc
			$LINK datamining/$val/$val.bc utilities/polybench.bc -o datamining/$val/$val$MERGED
			$OPT -load $DYNAALIB -load $ANALYSISLIB -map-annotations -get-opt-selective -get-func-file $val$FUNC_FILE -bench-name-read $val -get-dynaa -O0 datamining/$val/$val$MERGED -o datamining/$val/out.bc
        fi
    ...
    then
        ...
        then
        	cd $POLYBENCH/
        	$CLANG $NATIVE_FLAGS -I utilities -I linear-algebra/blas/$val linear-algebra/blas/$val/$val.c -DPOLYBENCH_DUMP_ARRAYS -DEXTRALARGE_DATASET -DPOLYBENCH_TIME -o linear-algebra/blas/$val/$val.bc
			$CLANG $NATIVE_FLAGS -I utilities utilities/polybench.c -DPOLYBENCH_TIME -o utilities/polybench.bc
			$LINK linear-algebra/blas/$val/$val.bc utilities/polybench.bc -o linear-algebra/blas/$val/$val$MERGED
			$OPT -O0 linear-algebra/blas/$val/$val$MERGED -o linear-algebra/blas/$val/out.bc
			$OPT $PREC_FLAG linear-algebra/blas/$val/out.bc -o linear-algebra/blas/$val/out_1.bc
        ...
        then
			...
			$OPT $VECT_FLAG linear-algebra/blas/$val/out.bc -o linear-algebra/blas/$val/out_1.bc
			$OPT $PREC_FLAG linear-algebra/blas/$val/out.bc -o linear-algebra/blas/$val/out_2.bc
			$CLANG $GETPHASE_FLAGS $INSTRFUNC linear-algebra/blas/$val/out_1.bc -o linear-algebra/blas/$val/$val -lm
			echo "Executing " $val 
			cd linear-algebra/blas/$val/ && ./$val > $val.$1.txt 2>&1
			diff <(head -n -1 $val.native.txt) <(head -n -1 $val.$1.txt)
			tail -1 $val.$1.txt
        ...
        then
			...
			$CLANG $USE_FLAGS -I utilities utilities/polybench.c -DPOLYBENCH_TIME -o utilities/polybench.bc
			$LINK linear-algebra/blas/$val/$val.bc utilities/polybench.bc -o linear-algebra/blas/$val/$val$MERGED
			$OPT -load $DYNAALIB -load $ANALYSISLIB -map-annotations -get-opt-selective -get-func-file $val$FUNC_FILE -bench-name-read $val -get-dynaa -O0 linear-algebra/blas/$val/$val$MERGED -o linear-algebra/blas/$val/out.bc
        fi
    ...
    then
        ...
        then
        	cd $POLYBENCH/
        	$CLANG $NATIVE_FLAGS -I utilities -I linear-algebra/kernels/$val linear-algebra/kernels/$val/$val.c -DPOLYBENCH_DUMP_ARRAYS -DEXTRALARGE_DATASET -DPOLYBENCH_TIME -o linear-algebra/kernels/$val/$val.bc
			$CLANG $NATIVE_FLAGS -I utilities utilities/polybench.c -DPOLYBENCH_TIME -o utilities/polybench.bc
			$LINK linear-algebra/kernels/$val/$val.bc utilities/polybench.bc -o linear-algebra/kernels/$val/$val$MERGED
			$OPT -O0 linear-algebra/kernels/$val/$val$MERGED -o linear-algebra/kernels/$val/out.bc
			$OPT $PREC_FLAG linear-algebra/kernels/$val/out.bc -o linear-algebra/kernels/$val/out_1.bc
        ...
        then
			...
			$OPT $VECT_FLAG linear-algebra/kernels/$val/out.bc -o linear-algebra/kernels/$val/out_1.bc
			$OPT $PREC_FLAG linear-algebra/kernels/$val/out.bc -o linear-algebra/kernels/$val/out_2.bc
			$CLANG $GETPHASE_FLAGS $INSTRFUNC linear-algebra/kernels/$val/out_1.bc -o linear-algebra/kernels/$val/$val -lm
			echo "Executing " $val 
			cd linear-algebra/kernels/$val/ && ./$val > $val.$1.txt 2>&1
			diff <(head -n -1 $val.native.txt) <(head -n -1 $val.$1.txt)
			tail -1 $val.$1.txt
        ...
        then
			...
			$CLANG $USE_FLAGS -I utilities utilities/polybench.c -DPOLYBENCH_TIME -o utilities/polybench.bc
			$LINK linear-algebra/kernels/$val/$val.bc utilities/polybench.bc -o linear-algebra/kernels/$val/$val$MERGED
			$OPT -load $DYNAALIB -load $ANALYSISLIB -map-annotations -get-opt-selective -get-func-file $val$FUNC_FILE -bench-name-read $val -get-dynaa -O0 linear-algebra/kernels/$val/$val$MERGED -o linear-algebra/kernels/$val/out.bc
        fi
    ...
    then
        ...
        then
        	cd $POLYBENCH/
        	$CLANG $NATIVE_FLAGS -I utilities -I linear-algebra/solvers/$val linear-algebra/solvers/$val/$val.c -DPOLYBENCH_DUMP_ARRAYS -DEXTRALARGE_DATASET -DPOLYBENCH_TIME -o linear-algebra/solvers/$val/$val.bc
			$CLANG $NATIVE_FLAGS -I utilities utilities/polybench.c -DPOLYBENCH_TIME -o utilities/polybench.bc
			$LINK linear-algebra/solvers/$val/$val.bc utilities/polybench.bc -o linear-algebra/solvers/$val/$val$MERGED
			$OPT -O0 linear-algebra/solvers/$val/$val$MERGED -o linear-algebra/solvers/$val/out.bc
			$OPT $PREC_FLAG linear-algebra/solvers/$val/out.bc -o linear-algebra/solvers/$val/out_1.bc
        ...
        then
			...
			$OPT $VECT_FLAG linear-algebra/solvers/$val/out.bc -o linear-algebra/solvers/$val/out_1.bc
			$OPT $PREC_FLAG linear-algebra/solvers/$val/out.bc -o linear-algebra/solvers/$val/out_2.bc
			$CLANG $GETPHASE_FLAGS $INSTRFUNC linear-algebra/solvers/$val/out_1.bc -o linear-algebra/solvers/$val/$val -lm
			echo "Executing " $val 
			cd linear-algebra/solvers/$val/ && ./$val > $val.$1.txt 2>&1
			diff <(head -n -1 $val.native.txt) <(head -n -1 $val.$1.txt)
			tail -1 $val.$1.txt
        ...
        then
			...
			$CLANG $USE_FLAGS -I utilities utilities/polybench.c -DPOLYBENCH_TIME -o utilities/polybench.bc
			$LINK linear-algebra/solvers/$val/$val.bc utilities/polybench.bc -o linear-algebra/solvers/$val/$val$MERGED
			$OPT -load $DYNAALIB -load $ANALYSISLIB -map-annotations -get-opt-selective -get-func-file $val$FUNC_FILE -bench-name-read $val -get-dynaa -O0 linear-algebra/solvers/$val/$val$MERGED -o linear-algebra/solvers/$val/out.bc
        fi
    elif [ $val == "deriche" ] || [ $val == "floyd-warshall" ] || [ $val == "nussinov" ];
    then
        if [ $1 == "native" ];
        then
        	$CLANG $NATIVE_FLAGS -I utilities -I medley/$val medley/$val/$val.c -DPOLYBENCH_DUMP_ARRAYS -DEXTRALARGE_DATASET -DPOLYBENCH_TIME -o medley/$val/$val.bc
			$CLANG $NATIVE_FLAGS -I utilities utilities/polybench.c -DPOLYBENCH_TIME -o utilities/polybench.bc
			$LINK medley/$val/$val.bc utilities/polybench.bc -o medley/$val/$val$MERGED
			$OPT -O0 medley/$val/$val$MERGED -o medley/$val/out.bc
			$OPT $PREC_FLAG medley/$val/out.bc -o medley/$val/out_1.bc
        ...
        then
			...
			$OPT $VECT_FLAG medley/$val/out.bc -o medley/$val/out_1.bc
			$OPT $PREC_FLAG medley/$val/out.bc -o medley/$val/out_2.bc
			$CLANG $GETPHASE_FLAGS $INSTRFUNC medley/$val/out_1.bc -o medley/$val/$val -lm
			echo "Executing " $val 
			cd medley/$val/ && ./$val > $val.$1.txt 2>&1
			diff <(head -n -1 $val.native.txt) <(head -n -1 $val.$1.txt)
			tail -1 $val.$1.txt
        ...
        then
			...
			$CLANG $USE_FLAGS -I utilities utilities/polybench.c -DPOLYBENCH_TIME -o utilities/polybench.bc
			$LINK medley/$val/$val.bc utilities/polybench.bc -o medley/$val/$val$MERGED
			$OPT -load $DYNAALIB -load $ANALYSISLIB -map-annotations -get-opt-selective -get-func-file $val$FUNC_FILE -bench-name-read $val -get-dynaa -O0 medley/$val/$val$MERGED -o medley/$val/out.bc
        fi
    ...
    then
        ...
        then
        	cd $POLYBENCH/
        	$CLANG $NATIVE_FLAGS -I utilities -I stencils/$val stencils/$val/$val.c -DPOLYBENCH_DUMP_ARRAYS -DEXTRALARGE_DATASET -DPOLYBENCH_TIME -o stencils/$val/$val.bc
			$CLANG $NATIVE_FLAGS -I utilities utilities/polybench.c -DPOLYBENCH_TIME -o utilities/polybench.bc
			$LINK stencils/$val/$val.bc utilities/polybench.bc -o stencils/$val/$val$MERGED
			$OPT -O0 stencils/$val/$val$MERGED -o stencils/$val/out.bc
			$OPT $PREC_FLAG stencils/$val/out.bc -o stencils/$val/out_1.bc
        ...
        then
			...
			$OPT $VECT_FLAG stencils/$val/out.bc -o stencils/$val/out_1.bc
			$OPT $PREC_FLAG stencils/$val/out.bc -o stencils/$val/out_2.bc
			$CLANG $GETPHASE_FLAGS $INSTRFUNC stencils/$val/out_1.bc -o stencils/$val/$val -lm
			echo "Executing " $val 
			cd stencils/$val/ && ./$val > $val.$1.txt 2>&1
			diff <(head -n -1 $val.native.txt) <(head -n -1 $val.$1.txt)
			tail -1 $val.$1.txt
        ...
        then
			...
			$CLANG $USE_FLAGS -I utilities utilities/polybench.c -DPOLYBENCH_TIME -o utilities/polybench.bc
			$LINK stencils/$val/$val.bc utilities/polybench.bc -o stencils/$val/$val$MERGED
			$OPT -load $DYNAALIB -load $ANALYSISLIB -map-annotations -get-opt-selective -get-func-file $val$FUNC_FILE -bench-name-read $val -get-dynaa -O0 stencils/$val/$val$MERGED -o stencils/$val/out.bc
        fi
    else
